...
async def client_buttons(update, context):
    ...
    if data == "client_home":
        ...
        await query.message.reply_text(
            ...
            "✅ Facebook\n"
            "✅ Instagram\n"
            "❌ YouTube не публікує банери\n\n"
            "🎨 Банер — розробка або просування готового банера включено\n"
            "🖼 Логотип компанії — за наявності\n\n\n"
            ...
            "🎨 Банер — розробка або просування готового банера включено\n"
            "🖼 Логотип компанії — за наявності\n"
            "🎥 Reels / Shorts — розробка або просування готового відео включено\n"
            "🤖 Відео з Тімом — розробка за потреби",
            reply_markup=back_home_keyboard(),
        )
